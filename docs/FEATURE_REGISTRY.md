...
| Release readiness | V0.7/V1.0 | QA | Automated baseline | AWO-55/AWO-76; `npm run test:release` runs lint, build, smoke, guided demo journey, visual QA, and writes `.qa/release-readiness/latest.json` |
