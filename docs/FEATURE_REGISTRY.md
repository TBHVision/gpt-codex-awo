...
| Release readiness | V0.7/V1.0 | QA | Automated baseline | AWO-55/AWO-76; `npm run test:release` runs lint, single-root app check, build, smoke, guided demo journey, cart/account/nav dead-end and recovery checks, visual QA, and writes `.qa/release-readiness/latest.json` |
