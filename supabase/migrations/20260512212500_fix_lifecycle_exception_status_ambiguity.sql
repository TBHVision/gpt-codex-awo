-- AWO-81: fix lifecycle exception status ambiguity.
-- The lifecycle exception RPC returns columns named order_item_id and
-- credential_status, so table reads inside the function must qualify both.
