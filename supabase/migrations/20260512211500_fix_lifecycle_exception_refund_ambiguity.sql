-- AWO-81: fix refund lifecycle exception ambiguity.
-- The original lifecycle exception RPC used an unqualified order_item_id reference
-- when re-reading the reveal credential after refund/revoke/transfer actions.
